...
#    subscriber_gems: "Subscribe today to purchase this hero with gems!"
    ...
    brain_pop_done: "Bạn đã đánh bại quân Orge bằng câu lệnh! Bạn đã thắng!"  #"You’ve defeated the Ogres with code! You win!"
    brain_pop_challenge: "Hãy thử thách bản thân bằng cách chơi lại với một ngôn ngữ lập trình khác xem!" #"Challenge yourself to play again using a different programming language!"
#    replay: "Replay"
